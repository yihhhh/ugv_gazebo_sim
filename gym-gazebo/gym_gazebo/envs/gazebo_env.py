...
class GazeboEnv(gym.Env):
    """
    BaseClass for all Gazebo environments.
    """
    ...
    def __init__(self):
        ...
        #     fullpath = launch
        # else:
        #     fullpath = os.path.join(os.path.dirname(__file__), "assets", "launch", launch)
        # if not os.path.exists(fullpath):
        #     raise IOError("File "+fullpath+" does not exist")

        # command = "roslaunch " + pkg_name + " " + launch
        # self._roslaunch = subprocess.Popen(command.split())
